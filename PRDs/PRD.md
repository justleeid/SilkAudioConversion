...
| PLIST → SILK | 从 plist 还原为 SILK 文件，默认输出微信兼容 SILK（wechatCompatible=true） | P1 |
...
1. **需求变更**: 先更新 PRD.md，再同步 development.md 与 ui.md
2. **接口变更**: 由 development.md 先定义，再回写 PRD.md 与 ui.md
3. **视觉调整**: 由 ui.md 更新，验证不影响 PRD 与 development.md
